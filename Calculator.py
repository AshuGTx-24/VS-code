...
"""
calculator programm using return function

"""
def addition2(num5,num6):
    add3=num5+num6
    return add3

def substraction2(num5,num6):
    sub2=num5-num6
    return sub2

def multiplication2(num5,num6):
    multi2=num5*num6
    return multi2

print(addition2(10,5))
